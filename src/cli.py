...
def generate(
    ...
    try:
        ...
        if output:
            ...
            console.print(f"[green]✅ Result сохранен в: {output}[/green]")
...
def train(
    ...
    """
    console.print(Panel.fit(
        "[bold green]LoRA Обучение[/] - Специалofация модели",
        border_style="green"
    ))
        ...
        "templates": [
            {
                ...
                "user_template": "Создай эксплойт для {vulnerability_type}. Включи:\n1. Description уязвимости\n2. Proof-of-Concept код\n3. Меры защиты\n4. Рекомендации по исправлению",
                "examples": []
            },
            {
                "name": "analyze_vulnerability",
                "description": "Аналof уязвимости в коде",
                "system_prompt": "Ты эксперт по аналofу кода и поиску уязвимостей. Проводи детальный аналof безопасности кода.",
                "user_template": "Проаналofируй следующий код на предмет уязвимостей:\n\n{code}\n\nВключи:\n1. Найденные уязвимости\n2. Уровень критичности\n3. Способы эксплуатации\n4. Рекомендации по исправлению",
                "examples": []
            },
            {
                "name": "reverse_engineering",
                "description": "Помощь в реверс-инжиниринге",
                "system_prompt": "Ты эксперт по реверс-инжинирингу и аналofу malware. Помогай в легальном аналofе программ для образовательных целей.",
                "user_template": "Помоги с реверс-инжинирингом:\n{target_description}\n\nВключи:\n1. Подход к аналofу\n2. Инструменты\n3. Методологию\n4. Пример кода для аналofа",
                "examples": []
            }
        ]
    }
